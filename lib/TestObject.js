...
TestObject.prototype.updateTest = function(sessionID, status, callback) {
    this.options.url = `https://app.testobject.com/api/rest/v2/appium/session/${sessionID}/test`
...
TestObject.prototype.skipTest = function(sessionID, callback) {
  this.options.url = `https://app.testobject.com/api/rest/v2/appium/session/${sessionID}/skiptest`;
  this.options.method = 'PUT';
...
TestObject.prototype.batchReports = function(body, callback) {
  url = `https://app.testobject.com/api/rest/v2/batchReports/${batchReportId}`;
  options = {
    'body' : JSON.stringify(body) || null,
    'headers': {
      'Accept':'application/json'
...
TestObject.prototype.batchReportsXML = function(body, callback) {
  url = `https://app.testobject.com/api/rest/v2/batchReports/${batchReportId}/xml`;
  options = {
    'body' : JSON.stringify(body) || null,
    'headers': {
      'Accept':'application/json'
